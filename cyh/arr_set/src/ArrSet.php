...
class ArrSet
{
     ...
     * @return
     */
    public static function newResult($results = [], $key = 'id', $field = '')
    {
        $results_new = [];
        if(!empty($results)) {
     ...
     * @return
     */
    public static function newResultsArr($results = [], $key = 'id')
    {
        $results_new = [];
        if(!empty($results)) {
            foreach($results as $val) {
     ...
     */
    public static function setKeyField($results = [], $data = [], $del_key = [])
    {
     ...
     * @return
     */
    public static function issets($value)
    {
     ...
     */
    public static function resultsArray(&$data)
    {
     ...
     */
    public static function resultsPregReplace(array $data_mac, string $template_str)
    {
     ...
     * @return array
     */
    public static function resultsInt(array $data)
    {
     ...
     * @return array|object
     */
    public static function resultsPids(array $data)
    {
        if(empty($data))
            return $data;
     ...
     * @return array|mixed
     */
    public static function getValueField($results = [], $args = [], $field = '', $type = 0)
    {
     ...
     */
    public static function setValueInt($data)
    {
        if(empty($data))
            return [];
     ...
     */
    public static function arrayFilterKeys($data = [], $keys = [])
    {
     ...
     * @return array
     */
    public static function unsetArrayValue(array &$arr,$val)
    {
     ...
     */
    public static function setArrayEle($data = [],$addArr = []){
